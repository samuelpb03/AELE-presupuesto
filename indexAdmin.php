        ...
        <div class="col-md-6">
            <div class="row justify-content-start button-container">
                <div class="col-12 text-center"> <!-- Menos margen, más centrado -->
                    ...
                    <a id="btn-compact" href="/dist/index2.html" style="display: none;">
                        <div id="caja2b" style="background: #b68e56;"
                             onmouseout="imagenDefecto()">PRESUPUESTADOR COMPACT</div>
                    </a>
                    <a id="btn-contract" href="/dist/index2.html" style="display: none;">
                        <div id="caja3b" style="background: #7a551c"
                             onmouseout="imagenDefecto()">PRESUPUESTADOR CONTRACT</div>
                    </a>
                    <a href="medicionc.pdf">
                        <div id="caja3b" style="background: #b68e56;"
                             onmouseout="imagenDefecto()">PLANTILLA MEDICIÓN</div>
                    </a>
                    <!-- Tercer botón -->
                    <a href="https://aele.es" target="_blank">
                        <div id="caja3b" style="background: #7a551c"
                             onmouseout="imagenDefecto()">VISITA NUESTRA WEB</div>
                    </a>
                    <a href="/administracionUsuarios.php" target="_blank">
                        <div id="caja2b" style="background: #7a551c"
                             onmouseout="imagenDefecto()">ADMINISTRACION</div>
                    </a>
                </div>
            </div>
        </div>
